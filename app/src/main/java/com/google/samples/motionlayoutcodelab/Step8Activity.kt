...
class Step8Activity : AppCompatActivity() {
    ...
    private fun coordinateMotion() {
        val appBarLayout: AppBarLayout = findViewById(R.id.appbar_layout) // get scrolled
        val motionLayout: MotionLayout = findViewById(R.id.motion_layout) // plays the animation
